...
<h1> <i><a href="newBlog.php"> Click Here </a></i> to create new blog.</h1>
									<h1><?php echo "My Blogs"; ?></h1>
								</div>
							</div>
...
$email = $_SESSION['email'];
			$query = "SELECT * FROM blog WHERE email_id='$email' ORDER BY date_and_time DESC;";
$cat_id = $row['category_id'];
	$query1 = "SELECT title FROM categories WHERE id= ORDER BY date_and_time DESC;";
							...
							<div class="col-md-12">
								<div class="post post-row">
									...
									<div class="post-body">
										...
										<h3 class="post-title"><a target="_blank" href="fullBlog.php?blogId=<?php echo $blogId ?>"><?php echo $row['title']; ?></a></h3>
										<div id="content"><p><?php echo $row['content']; ?></p> </div>
										<a target="_blank" href="fullBlog.php?blogId=<?php echo $blogId ?>"> Read More </a><br>
